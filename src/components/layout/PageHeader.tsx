...
export default function PageHeader() {
    ...
    return (
        <header className="flex items-center">
            <span className="text-[29px] font-[600] text-gray-700 dark:text-white tracking-tight">
                    ...
                    return (
                        <span key={href} className="flex items-center absolute left-[10px] -z-10">
                            {isLast ? (
                                ...
                                <Link href={href} className="hover:text-gray-700 dark:hover:text-white transition">
                                    {titleCase(segment)}
                                </Link>
                            )}
                        </span>
