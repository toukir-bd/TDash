          ...
          <BarChart data={data} barCategoryGap="2%">
            <defs>
              <linearGradient id="solid" x1="0" y1="0" x2="0" y2="1">
                <stop offset="0%" stopColor="rgba(129, 0, 255, 1)" />
                <stop offset="100%" stopColor="rgba(129, 0, 255, 1)" />
              </linearGradient>
              <pattern id="dots" width="4" height="4" patternUnits="userSpaceOnUse">
                <circle cx=".5" cy=".5" r="1" fill="rgba(129, 0, 255, 1)" />
              </pattern>
              <pattern id="stripes" width="7" height="7" patternUnits="userSpaceOnUse">
                <path d="M0 7 L7 0" stroke="rgba(129, 0, 255, 1)" strokeWidth="1" />
              </pattern>
              <linearGradient id="gradient" x1="0" y1="0" x2="0" y2="1">
                <stop offset="0%" stopColor="rgba(129, 0, 255, 1)" />
                <stop offset="100%" stopColor="rgba(129, 0, 255, 0)" />
              </linearGradient>
            </defs>
            <XAxis
              dataKey="name"
            ...
            <Bar dataKey="value" shape={<CustomBar />}>
              <LabelList dataKey="value" content={CustomLabel} className='bg-[#8100FF]'/>
            </Bar>
          </BarChart>
        </ResponsiveContainer>
      </div>
